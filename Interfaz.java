...
public class Interfaz extends javax.swing.JFrame {
    ...
    public Interfaz() {
        ...
        imagenes[0] = new ImageIcon("Imagen1.jpeg").getImage();
        imagenes[1] = new ImageIcon("Imagen2.jpeg").getImage();
        imagenes[2] = new ImageIcon("Imagen3.jpeg").getImage();
        imagenes[3] = new ImageIcon("Imagen4.jpeg").getImage(); 
    }
       ...
       TimerTask task = new TimerTask(){
        ...
        public void run()
        {
            if (c >= imagenes.length)
                c = 0;
            ImagenesLabel.setIcon(new ImageIcon(imagenes[c]));
            c++;
